...
Mr. Melo's stated purpose for hiring DesignCENTERING:
    Mr.Melo says that he founded Branchless in 2015 after he spent more time in that      year away from his home and it bacame prolomatic struggle with his bankin needs so     he came up with the idea to create a non-brick and mortar bank . He has since         realized as stated "that he is a physicist" and has asked for our help.

Purpose: Solve the Problems of Persons not staying in one location needing to interact commercially (in matters of commerce).

Users:  1) the persons mentionned in the purpose
        2) persons who may for whatever reason be unable to leave their residence
        3) persons who may for whatever reason be unable to enter into contracts or           agreements with modern day banking institutions
...
**************************************************************************************
DesignCENTERING scope of study to fully understand the scope of issues surrounding the central pupose proposes to
...
The details of this study and it's administration have been filed with encryption and you need the following code combined with your DC representative's responsive code to be openned. Your code is %5%6&99)000wowEEE. The following are brief overviews of the studies.
Venmo- has an unique social networking aspect that promised security to it's users. Users have to accept one another as members in order to recieve or deliver commercial instruments in this case known as US Dollars. Venmo earns its money through the interest it earns on the money exchanged between it's members. The members earn no interest on their funds. There are minimal or no fees to the members.  Venmo's model only survives using the brick and mortar of existing banking institutions as the transfer vehicle. Threat or issue to Venmo is that if the person needing to pay or be paid is not a member there cannot be commerce.  Potential solution for this would be the addition of a service where the Venmo user could subscribe to a third party that provides wiring capabilities to existing insittuitions.  

Apple Pay
Using an existing credit card company that has brick and mortar offices a user can tap an apple phone on a register and type in a code to have the apple account draft money from the existing credit cart. Advantages to this are that every time the card is swiped phsiccally or charged a notice is sent to the owner of the said card. Disadvaantages of this are that not all credit cards are created equal and some are more travel friendly tha tn other=s.  One interviewee said that they wish they could just tap a map to to show where they were traaveling and not worry again about there banking needs.  Another interviewee said that thaey would like to have a servise pay their bills or alert them that bills are ready to be paid.  Note this service already exists for some priemium cards that charge a higher annual fee. The Apple business market seems to rely on the users continued dependence on the IOS platform.
...
S.W.O.T.
STRENGTHS-new banking module, ease of banking from anywhere in the world

WEAKNESSES- security, hacking, loss of passwords, digital piracy, fraud, death before dis-empowerment, non-digital partners, areas where there is no signal

OPPORTUNITIES- provide equity and savings capability for those currently outside of the system, governmental embrace and utility recognition possibly

THREATS-existing banking institutions, government intervention
